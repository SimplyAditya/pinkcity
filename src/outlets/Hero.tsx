      ...
      <div className="w-full h-screen bg-white flex items-center justify-center pt-16 px-10">
        <div className="relative w-full h-11/12 text-center bg-[radial-gradient(circle,_#FE5E85,_#D93A61)] rounded-[59] flex flex-col items-center justify-end gap-10">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[59]">
            ...
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[10%] left-[8%] text-[#FE5E85] text-lg sm:text-xl md:text-2xl transform rotate-12 opacity-60" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[15%] right-[12%] text-[#D93A61] text-sm sm:text-lg md:text-xl transform -rotate-45 opacity-50" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[8%] left-[25%] text-[#FE5E85] text-xs sm:text-sm md:text-lg transform rotate-90 opacity-40" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[12%] right-[30%] text-[#D93A61] text-sm sm:text-lg transform -rotate-30 opacity-55" 
            />
            
            {/* Around main title stars */}
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[22%] left-[15%] text-[#D93A61] text-lg sm:text-xl md:text-2xl transform rotate-45 opacity-65" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[28%] right-[18%] text-[#FE5E85] text-sm sm:text-lg transform -rotate-60 opacity-45" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[25%] left-[40%] text-[#D93A61] text-xs sm:text-sm md:text-lg transform rotate-15 opacity-35" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[32%] right-[45%] text-[#FE5E85] text-sm sm:text-lg transform -rotate-75 opacity-50" 
            />
            
            {/* Between title and subtitle stars */}
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[38%] left-[10%] text-[#FE5E85] text-lg sm:text-xl transform rotate-90 opacity-60" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[42%] right-[8%] text-[#D93A61] text-sm sm:text-lg md:text-xl transform -rotate-12 opacity-55" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[40%] left-[35%] text-[#FE5E85] text-xs sm:text-sm transform rotate-135 opacity-40" 
            />
            <FontAwesomeIcon 
              icon={faStar} 
              className="absolute top-[44%] right-[35%] text-[#D93A61] text-sm sm:text-lg transform -rotate-45 opacity-45" 
            />
          ...
          <div className="flex items-center justify-center text-6xl text-white font-extrabold gap-6 relative z-10">
          ...
          <div className="relative h-3/10 min-h-48 w-full flex justify-center overflow-hidden">
            <button
              className={`absolute left-1/2 -translate-x-1/2 transition-all duration-1000 ${
                isAnimated ? "bottom-[80%]" : "bottom-[-10%]"
